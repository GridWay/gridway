...
/**
  * Thrown when the DRMAA implementation could not use the default contact string
  * to connect to GridWay.
  */
...
public class DefaultContactStringException extends InvalidContactStringException
{
	...
	public DefaultContactStringException(java.lang.String message)
	{
		super(message);
	}
}
