...
#define yyparse         host_update_parse
#define yylex           host_update_lex
#define yyerror         host_update_error
#define yylval          host_update_lval
#define yychar          host_update_char
#define yydebug         host_update_debug
#define yynerrs         host_update_nerrs
#define yylloc          host_update_lloc
...
/* Line 189 of yacc.c  */
#line 95 "host/gw_host_update_syntax.c"
...
/* Line 214 of yacc.c  */
#line 150 "host/gw_host_update_syntax.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 175 "host/gw_host_update_syntax.c"
...
{
      14,     0,    -1,    14,    15,    -1,    -1,     6,    10,     8,
      -1,     6,    10,     9,    -1,     6,    11,     8,    12,    10,
...
{
     -10,     0,   -10,    -9,    -7,   -10,     1,    -3,     3,     9,
     -10,   -10,    -4,   -10,   -10,     6,    10,    11,     5,     7,
     -10,   -10,   -10,   -10
};
...
{
       2,     6,     7,     8,     9,    12,     3,     4,    16,    10,
      11,    13,    14,    20,    21,    22,    23,    15,    17,     0,
      18,    19
};

static const yytype_int8 yycheck[] =
{
       0,    10,    11,    10,    11,     8,     6,     7,    12,     8,
       9,     8,     9,     8,     9,     8,     9,     8,    12,    -1,
      10,    10
};
...
{
       0,    14,     0,     6,     7,    15,    10,    11,    10,    11,
       8,     9,     8,     8,     9,     8,    12,    12,    10,    10,
       8,     9,     8,     9
};
...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (&yylloc, host, pos, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, gw_host_t *host, int *pos)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, host, pos)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, gw_host_t *host, int *pos)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, host, pos)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, gw_host_t *host, int *pos)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, host, pos)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    gw_host_t *host;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, host, pos); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, gw_host_t *host, int *pos)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, host, pos)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (gw_host_t *host, int *pos);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (gw_host_t *host, int *pos)
#else
int
yyparse (host, pos)
    gw_host_t *host;
...
/* Line 1455 of yacc.c  */
#line 1522 "host/gw_host_update_syntax.c"
      default: break;
    }
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (&yylloc, host, pos, YY_("syntax error"));
#else
      {
  ...
  if (yyerrstatus == 3)
      ...
      else
	{
	  yydestruct ("Error: discarding",
		      yytoken, &yylval, &yylloc, host, pos);
	  yychar = YYEMPTY;
	}
    }
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, yylsp, host, pos);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (&yylloc, host, pos, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, yylsp, host, pos);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
