...
/* Line 196 of yacc.c.  */
#line 123 "src/host/gw_host_rank_syntax.c"
...
/* Line 219 of yacc.c.  */
#line 147 "src/host/gw_host_rank_syntax.c"
...
#line 61 "src/host/gw_host_rank_syntax.y"
    { (yyval.val_int) = gw_host_get_var_int((yyvsp[0].val_int),queue,host);;}
    break;

  case 7:
#line 62 "src/host/gw_host_rank_syntax.y"
    { (yyval.val_int) = gw_host_get_genvar_int((yyvsp[0].val_str),queue,host);;}
    break;
...
/* Line 1126 of yacc.c.  */
#line 1232 "src/host/gw_host_rank_syntax.c"

  yyvsp -= yylen;
  yyssp -= yylen;
  yylsp -= yylen;
