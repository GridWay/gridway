...
public class StBulkSubmitInHoldSingleRelease extends StBulkSubmitInHold
{
	public StBulkSubmitInHoldSingleRelease(String executable)
	{
		super(executable, ST_BULK_SUBMIT_IN_HOLD_SINGLE_RELEASE);
	}
	...
	public void run()
	{
		...
		{				
			...
			for (int i=0;i<this.jobChunk;i++)
				this.session.control((String) this.ids.get(i),Session.DRMAA_CONTROL_RELEASE);
