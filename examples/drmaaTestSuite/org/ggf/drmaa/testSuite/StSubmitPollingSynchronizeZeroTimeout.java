	...
	{	
		try
		{
			...
			do
			{
				try
				{
					this.session.synchronize(Collections.singletonList(Session.DRMAA_JOB_IDS_SESSION_ALL), Session.DRMAA_TIMEOUT_NO_WAIT, false);
				...
				catch (ExitTimeoutException e)
				{
					...
					System.out.println("Slept " + this.timeout/1000 + " seconds");
				}
			}	
